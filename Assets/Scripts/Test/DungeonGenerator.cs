...
public class DungeonGenerator : MonoBehaviour
{
    ...
    void createMap()
    {
        ...
        layout.GenSteps.Add(new GenPriority<GenStep<MapGenContext>>(0, new DrawFloorToTileStep<MapGenContext>(10)));
        ...
        int terrain = 2;
        PerlinWaterStep<MapGenContext> waterPostProc = new PerlinWaterStep<MapGenContext>(new RandRange(35), 3, 1, new TileTest(terrain), false);
        ...
        layout.GenSteps.Add(new GenPriority<GenStep<MapGenContext>>(4, new DropDiagonalBlockStep<MapGenContext>(new TileTest(terrain))));
        //Remove water stuck in the walls
        layout.GenSteps.Add(new GenPriority<GenStep<MapGenContext>>(4, new EraseIsolatedStep<MapGenContext>(new TileTest(terrain))));
